 ...
 */
import { haversineDistanceKm, calculateSpeedKmh } from "./haversine";

export const haversine = haversineDistanceKm;
...
export const calculateSpeed = (distance, timeInSeconds) => {
  return calculateSpeedKmh(distance, timeInSeconds).toFixed(2);
};
